                    ...
                    <div class="card card-primary">
                        ...
                        <form action="<?= BASE_URL_ADMIN . '?act=update-quan-tri' ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input name="email" id="" class="form-control" value="<?=$quanTri['email']?>" placeholder="Nhập email">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="so_dien_thoai" value="<?=$quanTri['so_dien_thoai']?>" id="" class="form-control" placeholder="Nhập số điện thoại">
